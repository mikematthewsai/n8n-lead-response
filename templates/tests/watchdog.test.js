// Checks for templates/website-and-line-watchdog-sms.json.
...
//   cd templates/tests && npm install && node watchdog.test.js
const path = require('path');
const { DateTime, Settings } = require('luxon');
const wf = require(path.join(__dirname, '..', 'website-and-line-watchdog-sms.json'));
